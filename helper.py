...
def most_successful(df, sport):
    ...
    return (temp_df['Name'] .value_counts().reset_index(name='Medal_Count').rename(columns={'index': 'Name'}).merge(df, left_on='Name', right_on='Name', how='left')[['Name', 'Sport', 'region', 'Medal_Count']].drop_duplicates('Name').head(15)
    )
